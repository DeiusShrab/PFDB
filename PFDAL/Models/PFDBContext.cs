...
namespace PFDAL.Models
{
    public partial class PFDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.BestiaryId, e.EnvironmentId });
            });

            modelBuilder.Entity<BestiaryFeat>(entity =>
            {
                entity.HasKey(e => new { e.BestiaryId, e.FeatId });
            ...
            {
                entity.HasKey(e => new { e.BestiaryId, e.LanguageId });
            });

            modelBuilder.Entity<BestiarySkill>(entity =>
            {
                entity.HasKey(e => new { e.BestiaryId, e.SkillId });
            ...
            {
                entity.HasKey(e => new { e.BestiaryId, e.BestiaryTypeId });
            });
            ...
            modelBuilder.Entity<Faction>(entity =>
            {
                ...
                entity.Property(e => e.ParentFaction).HasColumnName("Parent Faction");

                entity.Property(e => e.PrimaryRace)
                    .HasColumnName("Primary Race")
                    .HasMaxLength(100)
                    .IsUnicode(false);
